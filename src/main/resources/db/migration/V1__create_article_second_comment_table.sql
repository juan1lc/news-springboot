CREATE TABLE article_second_comment
(
    ...
    CONSTRAINT  c_user_comment_article_comment_id
        FOREIGN KEY (userid) REFERENCES user (id),
    CONSTRAINT  c_comment_article_comment_id
        FOREIGN KEY (commentid) REFERENCES article_comment (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT '文章二级评论表'